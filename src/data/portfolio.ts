...
export const siteConfig = {
  ...
  resumeUrl: "/cv",
  cvPdfUrl: "/CV.pdf",
  cvFileName: "CV_Rahman_Nendhiarto_Terbaru.pdf",
  resumePdfUrl: "/Resume.pdf",
  resumeFileName: "Resume_Rahman_Nendhiarto_New.pdf",
  social: {
...
export const techCategories: { id: string; items: TechItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "vercel", name: "Vercel", icon: "▲", logo: "/images/tech/vercel.svg", logoInvertDark: true, color: "#000000" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "github", name: "GitHub", icon: "📦", logo: "/images/tech/github.svg", logoInvertDark: true, color: "#181717" },
      { id: "cursor", name: "Cursor", icon: "⌨", logo: "/images/tech/cursor.svg", logoInvertDark: true, color: "#000000" },
